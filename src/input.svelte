...
<input type="range" bind:value min="1" max="25" step="1" />
...
<style lang="css">
	...
	input[type='range']:focus::-webkit-slider-thumb {
		...
		background: linear-gradient(black 0 0) scroll no-repeat left center /
			50% calc(var(--track-height) + 1px);
	}
	input[type='range']::-webkit-slider-thumb {
		background-color: white !important;
		background: linear-gradient(white 0 0) scroll no-repeat left center /
			50% calc(var(--track-height) + 1px);
	}
